"use strict";
{
    ...
    //   Array
    const bros1 = ["munna", "suraiya", "love"];
    const bros2 = ["munna", "suraiya", "love"];
...
}
{
    ...
    const mentorlist = Object.assign(Object.assign({}, mentor1), mentor2); // this is the object that will include all the mentor from mentor1 and mentor2
}
//Rest Operator
